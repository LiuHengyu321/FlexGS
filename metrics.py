    ...
    for scene_dir in model_paths:
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                for dir_item in os.listdir(method_dir):
                    if "renders" not in dir_item:
                        continue
                    full_dict[scene_dir][method][dir_item] = {}
                    per_view_dict[scene_dir][method][dir_item] = {}
                    full_dict_polytopeonly[scene_dir][method][dir_item] = {}
                    per_view_dict_polytopeonly[scene_dir][method][dir_item] = {}
                    
                    renders_dir = method_dir / dir_item
                    ...
                    full_dict[scene_dir][method][dir_item].update({"SSIM": torch.tensor(ssims).mean().item(),
                    ...
                    per_view_dict[scene_dir][method][dir_item].update({"SSIM": {name: ssim for ssim, name in zip(torch.tensor(ssims).tolist(), image_names)},
